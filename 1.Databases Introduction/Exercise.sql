...
INSERT INTO
    Customers(DriverLicenceNumber, FullName, Address, City)
VALUES
...
INSERT INTO
    RentalOrders(EmployeeId, CustomerId, CarId, TankLevel, KilometrageStart, KilometrageEnd,
    StartDate, EndDate, RateApplied, OrderStatus)
VALUES
...
INSERT INTO
    Customers(FirstName, LastName, PhoneNumber)
VALUES
    ('A', 'E', '+359888666555'),
    ('Z', 'Q', '+359866444222'),
    ('W', 'R', '+35977555333')
...
INSERT INTO
    Payments(EmployeeId, PaymentDate, AccountNumber, FirstDateOccupied, LastDateOccupied, AmountCharged, TaxRate)
VALUES
...
INSERT INTO
    Occupancies(EmployeeId, DateOccupied, AccountNumber, RoomNumber, RateApplied, PhoneCharge)
VALUES
...
INSERT INTO
    Employees (FirstName, MiddleName, LastName, JobTitle, DepartmentId, HireDate, Salary)
VALUES
